...
class PersonalizedPageRankBasedRec:
    ...
    def create_itemitem_matrix(self):
        ...
        item_nodes = [n for n, attr in self.G.nodes(data=True) if attr['entity'] == 'A']
    ...
    def create_useritem_matrix(self):
        ...
        item_nodes = [n for n, attr in self.G.nodes(data=True) if attr['entity'] == 'A']
        user_nodes = [n for n, attr in self.G.nodes(data=True) if attr['entity'] == 'U']
    ...
    def create_sessionsession_matrix(self):
        ...
        session_nodes = [n for n, attr in self.G.nodes(data=True) if attr['entity'] == 'S']
